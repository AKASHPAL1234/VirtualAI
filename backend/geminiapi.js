...
export const geminiresponse = async (command,assistantName,username) => {
  try {
    const geminiurl = process.env.GEMINI_API_KEY;
...
aur agar koi aisa question puchta hai jiska answer tume pata hai usko bhi general category me rakho bas short answer dena 
